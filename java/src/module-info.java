module java {
	...
	opens application.ep2 to javafx.graphics, javafx.fxml, jdx; // Abrir el paquete a los modulos a ep1
	...
	exports application.ep2 to javafx.graphics, javafx.fxml, jdx; // Exportar el paquete a los modulos a ep1
